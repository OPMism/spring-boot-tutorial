...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Let inspect the beans provided by Spring Boot:");
...
```
\src\main\java\com\mastering\spring\springboot\bean\TodoNotFoundException.java
```
package com.mastering.spring.springboot.bean;
...
public class BasicController {
	...
	@RequestMapping(method = RequestMethod.GET, path = "/welcome-with-object")
	public WelcomeBean welcomeWithObject() {
		return new WelcomeBean("Hello World");
	}

	@RequestMapping(method = RequestMethod.GET, path = "/welcome-with-parameter/name/{name}")
...
public class TodoController {
	...
	@RequestMapping(method = RequestMethod.GET, path = "/users/{name}/todos")
	public List<Todo> retrieveTodos(
			@PathVariable String name) {
		return todoService.retrieveTodos(name);
	}

	@RequestMapping(method = RequestMethod.GET, path = "/users/{name}/todos/{id}")
...
```
\src\main\java\com\mastering\spring\springboot\service\GlobalExceptionHandler.java
```
...
```
\src\main\java\com\mastering\spring\springboot\service\RestResponseEntityExceptionHandler.java
```
package com.mastering.spring.springboot.service;
...
```
\src\main\java\com\mastering\spring\springboot\SwaggerConfig.java
```
package com.mastering.spring.springboot;
...
public class TodoControllerIT {
	...
	@Test
	public void addTodo_ValidationError() throws Exception {
		String expected = "{status:400,"
				+ "exception:org.springframework.web.bind.MethodArgumentNotValidException,"
				+ "errors:[{defaultMessage: Enter atleast 10 Characters.,field: desc}]}";

		Todo todo = new Todo(-1, "Jill", "Learn",
				new Date(), false);

		String response = template.postForObject(
				base.toString() + "/users/Jill/todos", todo,
				String.class);
